...
class FibonacciBaseTest(object):
...
class FibonacciIterativeTest(FibonacciBaseTest, unittest.TestCase):
...
class FibonacciDoublingTest(FibonacciBaseTest, unittest.TestCase):
